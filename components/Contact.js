      ...
      >
        <Modal.Header closeButton>
          <Modal.Title id="example-modal-sizes-title-sm">
            <div class="text-center text-success">Message Sent Successfully</div>
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <div class="text-center">
          I will get back to you soon <span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-heart" viewBox="0 0 16 16">
